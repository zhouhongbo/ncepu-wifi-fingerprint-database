...
scatter(trn1.coords(:,1),trn1.coords(:,2), [], 'black', 'x');
hold on;
scatter(trn2.coords(:,1),trn2.coords(:,2), [], 'black', 'x');
hold on;
...
ylabel('y/m');
axis square;
set(gca,'XDir','reverse', 'fontsize', 10.5, 'fontname', '宋体'); % 将x轴方向设置为反向(从右到左递增)